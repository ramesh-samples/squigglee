...
public class PatternHandlerImpl extends IndexHandlerImpl implements IPatternHandler {
	private static Logger logger = Logger.getLogger("com.squigglee.storage.mapdb.PatternIndexHandlerImpl");
	
	@Override
	public List<Long> fetchCandidatePatterns(MasterData md, String idxTableName, List<String> hashes)
			throws TimeSeriesException {
		List<Long> candidates = new ArrayList<Long>();
		DB db = getDatabase(idxTableName + "_" + md.getId());
		ConcurrentNavigableMap<Object, Object> map = getTable(idxTableName + "_" + md.getId(), IndexType.parseIndexTableName(idxTableName).toString());
	...
	public void updatePatternIndex(MasterData md, String idxTableName, long startKey, long endKey,
		...
		DB db = getDatabase(idxTableName + "_" + md.getId());
		ConcurrentNavigableMap<Object,Object> map =  getTable("" + md.getId(), IndexType.parseIndexTableName(idxTableName).toString());
