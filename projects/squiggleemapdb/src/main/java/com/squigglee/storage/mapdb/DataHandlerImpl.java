...
public class DataHandlerImpl extends MasterDataHandlerImpl implements IDataHandler {
	private static Logger logger = Logger.getLogger("com.squigglee.storage.mapdb.DataHandlerImpl");
	...
	public int[] insertBulkData(byte[] bulkData) throws TimeSeriesException {
		...
		for (int i = 0; i< insertCounts.length; i++) {
			...
			try {
				...
				ConcurrentNavigableMap<Object,Object> map = getTable("" + masterData.getId(), masterData.getDatatype());
	...
	public void deleteData(int ln, String guid, long begints, long beginoffset, long endts, long endoffset) throws TimeSeriesException {
		...
		for (MasterData md : getMasterData(ln, guid, begints, endts)) {
			...
			ConcurrentNavigableMap<Object,Object> map = getTable("" + md.getId(), md.getDatatype());
	...
	@Override
	public SortedMap<Object,Object> fetchTimeSeries(MasterData md, long start, int startOffset, long end, int endOffset) throws TimeSeriesException {
		SortedMap<Object,Object> ts = new TreeMap<Object, Object>();
		
		DB db = getDatabase("" + md.getId());
		SortedMap<Object,Object> data = getTable("" + md.getId(), md.getDatatype()).subMap(new Long(start), true, new Long(end), true);
	...
	public SortedMap<Integer, Object> fetchTimeSeriesLimit(long id, String dataType,
		...
		ConcurrentNavigableMap<Object,Object> map = getTable("" + id, list.get(0).getDatatype());
	...
	private void setSerializedData(MasterData md, long beginoffset, long endoffset, ITimeSeriesSerializer serializer) throws TimeSeriesException {
		...
		//serializer.setBlockCount(1);
		 ...
		 SortedMap<Object,Object> map = fetchTimeSeries(md, (int) beginoffset, 0, (int) endoffset, 0);
